...
public class RegisModule {


    private static String username;
    private static String appid;
    private static String challenge;
    private static String reg_portal;
    private static String keyhandle;
    private static String keypub;
    static boolean success = false;
    // preparing send data
    // sent to reg_force.php (using retrofit to sent to url method post)
    // get return from reg_force.php
...
//    }
    ...
    static public void main(JSONObject reader, final Context context){
        ...
        keyhandle = Encryption.generateKeyHandle();
        keypub = null;
        try {
            keypub = Encryption.createKey(keyhandle,context);
            Log.v("Finally, my RSA Pub Key", keypub);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            reg_portal = reader.getString("reg_portal");
            sendToRegPortal(username, challenge, reg_portal, keyhandle, keypub, context);
    ...
    static public void sendToRegPortal(final String username, String challenge, String reg_portal, final String keyhandle, String keypub, final Context context){
